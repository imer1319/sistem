...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateUsuario: function updateUsuario(editUser) {
      var _this4 = this;
    ...
    updateAvatar: function updateAvatar(editUser) {
      var _this5 = this;
                        ...
                        "form",
                        {
                          ...
                          on: {
                            submit: function($event) {
                              $event.preventDefault()
                              return _vm.updateAvatar(_vm.editUser)
                            }
                          }
                        },
                        [
                                ...
                                _c(
                                  "form",
                                  {
                                    ...
                                    on: {
                                      submit: function($event) {
                                        $event.preventDefault()
                                        return _vm.updateUsuario(_vm.editUser)
                                      }
                                    }
                                  },
                                  [
                                            ...
                                            directives: [
                                              {
                                                ...
                                                rawName: "v-model",
                                                value:
                                                  _vm.editUser.apellido_paterno,
                                                expression:
                                                  "editUser.apellido_paterno"
                                              }
                                            ],
                                            staticClass: "form-control",
                                            attrs: {
                                            ...
                                            directives: [
                                              {
                                                ...
                                                rawName: "v-model",
                                                value:
                                                  _vm.editUser.apellido_materno,
                                                expression:
                                                  "editUser.apellido_materno"
                                              }
                                            ],
                                            staticClass: "form-control",
                                            attrs: {
