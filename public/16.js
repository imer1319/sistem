...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    mostrarMiPosicion: function mostrarMiPosicion() {
      var _this2 = this;

      axios.get("/miID").then(function (res) {
        _this2.miIdentificador = res.data;
...
var render = function() {
  ...
  return _vm.loading
    ...
    : _c("div", { staticClass: "container-fluid" }, [
        _c("div", { staticClass: "titulo" }, [_vm._v("ranking")]),
        _vm._v(" "),
        _c("div", { staticClass: "row" }, [
          _c(
            "div",
            { staticClass: "col-md-5 col-sm-12 mb-3 mt-4" },
            _vm._l(_vm.rankings, function(ran, index) {
              return ran.id == _vm.miIdentificador
                      ...
                      _c("div", { staticClass: "card-body contenedor" }, [
                        ...
                        _c("div", { staticClass: "imagen" }, [
                          _c("img", {
                            ...
                            attrs: { src: "/imagenes/usuario/" + ran.avatar }
                          })
                        ])
                      ]),
                      _vm._v(" "),
          ...
          _vm._v(" "),
          _c("div", { staticClass: "col-md-7 col-12 mt-4" }, [
            _c("div", { staticClass: "card" }, [
              _c("h3", { staticClass: "text-center pt-4" }, [
