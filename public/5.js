  ...
  methods: {
    ...
    guardarResultado: function guardarResultado() {
      ...
      axios.post('/game', formData).then(function (res) {
        _this2.guardarEjercicio.ejercicio_id = "";
        _this2.guardarEjercicio.user_id = "";
        _this2.guardarEjercicio.puntos = "";
        _this2.puntuacion = 0;
        _this2.pasos = 6;
      });
    },
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "card mb-3" }, [
      _c("div", { staticClass: "card-body" }, [_c("p", [_vm._v("Puntuacion")])])
    ])
  },
  function() {
    var _vm = this
