...
/* harmony default export */ __webpack_exports__["default"] = ({
  mounted: function mounted() {
    ...
    this.consejo = this.consejos[random];
  },
  data: function data() {
    return {
      content: [{
              ...
              [
                _c("router-link", { attrs: { to: contenido.url } }, [
                  _c("div", { staticClass: "my-2" }, [
                    _c(
                      "div",
                      { staticClass: "card shadow-sm border-rounded" },
                      [
                        _c(
                          "div",
                          ...
                          [
                            _c("img", {
                              ...
                              attrs: { src: "/imagenes/" + contenido.icono }
                            })
                          ]
                        ),
                        _vm._v(" "),
                        _c(
                          "span",
                          { staticClass: " pb-3 text-center text-uppercase" },
                          [_vm._v(_vm._s(contenido.name))]
                        ),
                        _vm._v(" "),
                        _c("span")
                      ]
