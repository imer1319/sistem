...
<head>
    ...
    <style>
        ...
        #home{
            background: url(imagenes/landing/mountains.jpeg) no-repeat center fixed;
            display: table;
            height: 100%;
            position: relative;
            width: 100%;
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" >
      ...
      <a href="#" class="navbar-brand"><img src="imagenes/landing/w3newbie.png" height="50px"></a>
...
<div class="padding">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <img src="imagenes/landing/bootstrap.png" width="100%">
      </div>
...
<div class="padding">
    <div class="container">
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <img src="imagenes/landing/sass.png" class="img-responsive" width="100%">
      </div>
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <h4>And Less</h4>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <img src="imagenes/landing/less.png" class="img-responsive" width="100%">
      </div>
  </div>
</div>
</div>
