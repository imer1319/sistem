...
<body style="overflow-x: hidden;">
	<div id="app">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-6 col-md-3 mb-4">
						<div class="card">
							<div class="card-body">
								<img src="imagenes/inicio/campo visual.png" class="img-second">
								<div class="card-title text-center">
									<b>Trata de ampliar tu campo visual lo mas que puedas</b>
								</div>
								<div class="text-justify card-text text-secondary">
									<p>Empieza con una sola palabra y luego puedes ampliar hasta cuatro palabras.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-6 col-md-3 mb-4">
						<div class="card">
							<div class="card-body text-center">
								<img src="imagenes/inicio/veloz.png" width="80%" height="120">
								<div class="card-title text-center">
									<b>Trata de agilizar tu velocidad de lectura</b>
								</div>
								<div class="text-justify card-text text-secondary">
									<p>Siempre practica la velocidad ya que ese es el principal objetivo</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-6 col-md-3 mb-4">
						<div class="card">
							<div class="card-body">
								<img src="imagenes/inicio/aprender.png" class="img-second">
								<div class="card-title text-center">
									<b>No dejes de practicar y esforzarte por tu meta</b>
								</div>
								<div class="text-justify card-text text-secondary">
									<p>Lo mas importante es que sigas practicando y no darse por vencido.</p>
								</div>
							</div>
						</div>
					</div>
		...
		<footer class="text-white text-center py-4" style="background: #2e2e2e;">
