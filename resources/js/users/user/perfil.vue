          ...
          <div class="col-sm-12 col-md-6 mb-3">
            <div class="card shadow">
              <div class="card-widget widget-user">
                ...
                <form
                  v-on:submit.prevent="updateAvatar(fillUsuario)"
                  ...
                  <div class="tab-pane" id="datos">
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <form
                          v-on:submit.prevent="updateUsuario(fillUsuario)"
                          enctype="multipart/form-data"
                        >
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-8">
                              <input
                                type="text"
                                class="form-control"
                                v-model="fillUsuario.apellido_paterno"
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-8">
                              <input
                                type="text"
                                class="form-control"
                                v-model="fillUsuario.apellido_materno"
