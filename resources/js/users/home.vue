<template>
	<div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4"v-for="contenido in content">
                <div class="text-center">
                    <router-link :to="contenido.url">
                        <div class="my-2">
                            <div class="card card-primary card-outline m-auto"style="box-shadow: 0px 3px 2px #aab2bd;"
                            :class="[contenido.numero%2==1?'color1':'color2']">
                            <span class="text-center text-uppercase">{{ contenido.nombre }}</span>
                            <div class="card-body box-profile text-center">
                                <img :src="`/imagenes/${contenido.icono}`" height="140">
                            </div>
                        </div>
                    </div>
                </router-link>
...
<script>
	export default{
        data() {
            return { 
                content :[
                {nombre:'Lecciones',icono:'lecciones.png',url:'',numero:1},
