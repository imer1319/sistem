<template>
    <div class="col-12">
        <!-- crear registro -->
        <form
            v-on:submit.prevent="agregarCategoria"
                            ...
                            <div class="form-group">
                                ...
                                <figure>
                                    ...
                                    <img
                                        ...
                                        height="200"
                                        :src="
                                            `imagenes/categorias/${fillCategoria.icono}`
                                        "
                                        v-else
                                    />
                                </figure>
            ...
            <div class="card-body" v-else>
                <paginate name="categorias" :list="categorias" :per="4">
                    <table class="table table-bordered table-striped py-5">
                        ...
                        <tbody>
                            <tr
                                v-for="(categoria, index) in paginated(
                                    'categorias'
                                )"
                                :key="index"
                            >
                                ...
                                <td class="text-center" colspan="2">
                                    ...
                                    <a
                                        href="#"
                                        class="btn btn-warning color-letra"
                                        @click="editarCategoria(categoria)"
                                        ><i class="fas fa-pencil-alt"></i>
                                        Editar</a
                                    >
                                    <a
                                        href="#"
                                        class="btn btn-danger color-letra"
                                        v-on:click="
